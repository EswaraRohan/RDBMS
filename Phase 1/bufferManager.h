...
class BufferManager{
    ...
    void Swap(string tableName, int pageIndex, int elementIndex , int val);
    void updatePage(string tableName,int pageIndex, vector<int> rows, int count);
    void writePage(string tableName, int pageIndex, vector<int> rows, int count);
    Page getPage(string tableName, int pageIndex,int entity);
    Page insertIntoPool(string tableName, int pageIndex,int entity);
    vector<int> readPage(string tableName,int pageIndex);
};