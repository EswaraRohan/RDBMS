...
Page::Page(string tableName,int tabIndex, int pageIndex)
{
    logger.log("Page::Page");
    this->tableName = tableName;
    this->pageIndex = pageIndex;
    this->tabIndex = tabIndex;
    this->pageName = "../data/temp/" + this->tableName +"_"+to_string(tabIndex)+"_Page" + to_string(pageIndex);
...
Page::Page(string tableName,int tabIndex, int pageIndex, vector<vector<int>> rows, int rowCount)
{
    logger.log("Page::Page");
    this->tableName = tableName;
    this->pageIndex = pageIndex;
